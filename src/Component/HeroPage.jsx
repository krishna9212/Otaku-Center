...
function HeroPage() {
  ...
  return (
    <div className="heropage h-screen w-screen z-10 relative overflow-hidden bg-black">
      ...
      {/* Hero Content */}
      <div className="HeroUpper w-full h-[80%] flex  flex-col justify-end  md:-mt-0 -ml-9 md:-ml-0 items-start relative px-[4rem] z-10">
      ...
      {/* Hero Options */}
      <div className="HeroOptions w-full mt-[2rem] md:mt-[0rem] md:pt-0 h-[13%] md:h-[20%] p-1 flex justify-center items-center gap-2 relative z-10">
        {/* Image 1 */}
        <div
